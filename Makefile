...
ObjetosCompilados/main.elf: Example1src/main.f90 main.o ddassl.o
	$(LINKER) $(F90_BASIC_OPTIONS) $(F90_DEBUG_OPTIONS) -JObjetosCompilados/ $(TodosObjetosCompilados) -o ObjetosCompilados/main.elf
