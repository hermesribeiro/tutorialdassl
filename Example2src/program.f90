...
!O CÓDIGO AQUI PRESENTE RESOLVE UM PROBLEMA DE BALANÇO DE MASSA
...
Program main
    ...
    TEND=20.D0              !DURAÇÃO DA SIMULAÇÃO
    ...
    WRITE(saidaFnum,*) ' TEMPO   nL     nI   dnL     dnI'
    WRITE(*,*)         ' TEMPO   nL     nI   dnL     dnI'
