...
${OBJECTDIR}/DAUX.o: DAUX.for 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/DAUX.o DAUX.for

${OBJECTDIR}/DDASSL.o: DDASSL.for 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/DDASSL.o DDASSL.for

${OBJECTDIR}/DLINPK.o: DLINPK.for 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/DLINPK.o DLINPK.for
...
${OBJECTDIR}/RES.o: RES.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/RES.o RES.f90
